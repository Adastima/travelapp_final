...
class Hotel: NSObject, Codable {
    ...
    static func generateDatas(sourceArray: inout [Hotel]) {
        sourceArray = [
            ...
            Hotel(name: "D-Maris Bay",  website: "dhotel.com", location: "Hisarönü Mevki, Datça Yolu 35. Km, 48380 Marmaris/Muğla, Turkey", phone: "00 90 252 441 2000", summary: "D Maris Bay’s fabulous setting, superb food and extensive facilities make it one of the best, if not the best, luxury resort on Turkey’s Turquoise Coast. Five white-sand beaches, a water ski school, indoor and outdoor pools, and a huge spa with 10 treatment rooms mean you're unlikely to be stuck for something to do.",image:"maris.jpg", isVisited: false),
...
//
//
//    init(name: String, website: String, location: String, phone: String, summary: String, imgCount: Int, image: [String], isVisited: Bool) {
//        self.name = name
//        self.website = website
//        self.location = location
//        self.phone = phone
...
//
//    convenience override init() {
//        self.init(name: "", website: "", location: "", phone: "", summary: "", imgCount: 4, image: [""], isVisited: false)
//    }
//
//    static func generateDatas(sourceArray: inout [Hotel]) {
//        sourceArray = [
//            Hotel(name: "Hotel Villa Turka", website: "villaturka.com", location: "Tophane Mah. Kargı Sk. No:7 Alanya, Alanya, 07400, Turkey", phone: "00905305474641", summary: " A stylish hotel with comfortable rooms, wonderful home-cooking and superb views. It attracts a multi-national crew of discerning travellers who want distinctive accommodation in one of the most picturesque locations on Turkey’s Mediterranean shore.", imgCount: 4, image: ["villaturka", "villaturka1", "villaturka2","villaturka3"],  isVisited: false),
//
//
//            Hotel(name: "Courtyard Hotel Kalkan", website: "courtyardkalkan.com",  location: "Suleyman Yilmaz Cad. No 24 & 26, Kalkan, 07960, Turkey", phone: "00902428443738", summary: " This boutique hotel nestled in a former Greek fishing village is as stylish as it is historic, serving brilliant breakfasts on a terrace with sweeping views, not to mention impromptu rooftop barbecues. ",imgCount: 4, image:["courtyard","courtyard1", "courtyard2","courtyard3"], isVisited: false),
//
//            Hotel(name: "Likya Yolu Palas Hotel",  website: "likyayolupalas.com",  location: "Kapakli Koyu NO:44 Demre Kekova/Antalya, Kapaklı, 07570", phone: "009002428742222", summary: "A traditionally built property with just five bedrooms, located on a rocky hillside high above the sea, Likya Yolu Palas is an intimate place to stay. The owners will happily pass on tips for local walks, and cook up fresh Turkish fare on the roof terrace. ",imgCount: 4, image:["likya","likya1", "likya2", "likya3"],isVisited: false),
//
//            Hotel(name: "Sumahan on the Water", website: "sumahan.com", location: "Kuleli Cad. No:51 Cengelkoy, Istanbul, 34684, Turkey", phone: "02164228000", summary: "Formerly an Ottoman-era distillery, this place was converted into an award-winning hotel by its discerning Turkish-American owners. As the hotel is situated on the Asian side of the Bosphorus Strait, guests arrive from Europe in the hotel’s own launch. There can be few finer ways to begin a visit to Istanbul.", imgCount: 4, image:["sumahan", "sumahan1", "sumahan2", "sumahan3"],  isVisited: false),
//            Hotel(name: "Hotel Villa Mahal",  website: "villamahal.com", location: "Hotel Villa Mahal, P.K.4 Kalkan, 07960 Antalya, Turkey", phone: "02428443268", summary: "One of the very best boutique hotels in this beautiful corner of southwestern Turkey. Small, friendly, extremely stylish and superbly run, it’s the ideal place for a relaxing romantic break or as the base for exploring the fabulous ancient sites, gorgeously indented coastline and mountainous hinterland of Lycia.mahal",imgCount: 4, image:["mahal", "mahal1", "mahal2","mahal3"], isVisited: false),
//
//            Hotel(name: "Georges Hotel Galata",  website: "georges.com", location: "Serdar-i Ekrem Sok No:24 Galata Beyoglu, Istanbul, 34420, Turkey", phone: "00902122442423", summary: "The epitome of the new wave of hip boutique hotels to open in the city's old European quarter, Georges makes the most of the beautiful, 19th-century apartment building from which it is fashioned, yet knows exactly what its discerning clientele want from their accommodation in this vibrant city. ", imgCount: 4, image:["galata", "galata1", "galata2", "galata3"], isVisited: false),
//            Hotel(name: "D-Maris Bay",  website: "dhotel.com", location: "Hisarönü Mevki, Datça Yolu 35. Km, 48380 Marmaris/Muğla, Turkey", phone: "00902524412000", summary: "D Maris Bay’s fabulous setting, superb food and extensive facilities make it one of the best, if not the best, luxury resort on Turkey’s Turquoise Coast. Five white-sand beaches, a water ski school, indoor and outdoor pools, and a huge spa with 10 treatment rooms mean you're unlikely to be stuck for something to do.", imgCount: 4,image:["maris","maris1", "maris2","maris3"], isVisited: false),
//            Hotel(name: "Degirmen (The Watermill)", website: "natur-reisen.de", location: "Faralya Koyu, Hisar Mah 4, Fethiye, Turkey", phone: "00902526421245", summary: "Those in search of individual accommodation, where relaxing, eating healthily and walking in spectacular mountain scenery are more important than roasting on a beach, will love Degirmen, with its stunning views, rustic rooms and a traditional Turkish restaurant. ",imgCount: 4, image:["degirmen", "degirmen1","degirmen2","degirmen3"],  isVisited: false),
//            Hotel(name: "Pera Palace Hotel", website: "perapalace.com", location: "Meşrutiyet Caddesi 52, Tepebaşı, Beyoğlu 34430 Istanbul, Turkey", phone: "00902123774000", summary: "They don’t come more history-filled or atmospheric than this, the hotel built by Belgian entrepreneur Georges Nagelmackers to accommodate travellers arriving on his Orient Express train from Paris. Guests here have included everyone from Ernest Hemingway and Agatha Christie to Atatürk and Greta Garbo.", imgCount: 4, image: ["pera","pera1", "pera2", "pera3"],  isVisited: false),
//            Hotel(name: "Raffles Istanbul", website: "raffles.com", location: "Zorlu Center Besiktas, Istanbul, 34340, Turkey", phone: "00902129240200", summary: "Unlike the majority of luxury hotels in Istanbul, Raffles does not pay homage to the city’s bygone Byzantine and Ottoman eras, but stands instead as a symbol of a modern, self-confident Turkey. The hotel forms part of the award-winning Zorlu Centre, which comprises an upmarket shopping centre and performance venue.", imgCount: 4, image: ["raffles", "rafffles1","raffles2","raffles3"],  isVisited: false),
//
//            Hotel(name: "Sabrina’s Haus", website: "sabrinashaus.com", location: "Adatepe Mevkii Bozburun, 48710 Muğla, Turkey", phone: "00902524562045", summary: " A stylish hotel with comfortable rooms, wonderful home-cooking and superb views. It attracts a multi-national crew of discerning travellers who want distinctive accommodation in one of the most picturesque locations on Turkey’s Mediterranean shore.",imgCount: 4,image:["sabrina","sabrina1", "sabrina2", "sabrina3"],  isVisited: false),
//
//            Hotel(name: "Hillside Beach Club", website: "hillsidebeachclub.com",  location: "Belen Cad. No:132 Kalemya Koyu, 48300 Fethiye/Muğla, Turkey", phone: "00902526148360", summary: "The Hillside Beach Club is a big, cheerful resort with all the workings of a small town and extensive facilities for families and couples. Its idyllic, pine-clad setting will appeal to anyone looking to kick back and relax.",imgCount: 4, image:["hillside","hillside1" ,"hillside2", "hillside3"], isVisited: false),
//
//            Hotel(name: "Tomtom Suites", website: "tomtomsuites.com", location: "Boğazkesen Caddesi. Tomtom Kaptan Sokak No.18 Beyoglu, Istanbul, 34413, Turkey", phone: "00902122924949", summary: "Very few visitors to the exotic, 'Oriental' city of Istanbul would expect to stay in a chic hotel fashioned from a former Franciscan nunnery. But Tomtom Suites, like the city in which it is located, is full of surprises – not least because it offers great value for such stylish accommodation. ",imgCount: 4, image:["tomtom","tomtom1", "tomtom2", "tomtom3"],  isVisited: false),
//
//            Hotel(name: "Four Seasons Hotel Istanbul at Sultanahmet", website: "fourseasons.com", location: "Tevkifhane Sok., No:1, Sultanahmet, Istanbul, 34110, Turkey", phone: "00902126388200", summary: "This luxurious hotel is actually fashioned from a late-Ottoman era prison once used to incarcerate writers, artists and other dissidents, though it has been so brilliantly converted you'd never guess. Its location in the heart of the city means it's a stone's throw from many of Istanbul's most famous sights.",imgCount: 4, image:["fourseason","fourseason1", "fourseason2", "fourseason3"],  isVisited: false),
//
//            Hotel(name: "Tuvana Hotel", website: "tuvanahotel.com",  location: "Tuzcular Mah.Karanlik Sok. No:18, Antalya, 07254, Turkey", phone: "00902422476015", summary: "If you're seeking a calming getaway in the heart of Antalya’s old quarter, this is it. The location is a cluster of handsome Ottoman houses set around marvellous bougainvillea gardens and a swimming pool. There's a bar, a restaurant popular with locals, and breakfast, served in a pretty courtyard, feels like a treat. ", imgCount: 4, image:["tuvana", "tuvana1","tuvana2","tuvana3"],  isVisited: false),
//
//            Hotel(name: "Romance Istanbul Hotel", website: "romanceistanbulhotel.com", location: "Hüdavendigar Cad. No: 5 Sirkeci, Istanbul, 34110, Turkey", phone: "00902125128676", summary: "Romance Istanbul has been transformed from a run of the mill establishment to one of the most luxurious hotels in bustling Sirkeci, right in the heart of the old city. This hotel does not pander to the hip and ephemeral but trades instead on good, old-fashioned comfort and top-quality service.",imgCount: 4, image:["romance", "romance1", "romance2", "romance3"],  isVisited: false),
//
//            Hotel(name: "Sub Karaköy",website: "subkarakoy.com",  location: " Necatibey Cad. No: 91 Karakoy, Istanbul, 34425, Turkey", phone: "00902122430005", summary: "Karaköy has found a new lease of life as Istanbul's hippest neighbourhood. Nowhere epitomises the dramatic changes Karaköy has undergone over recent years than Sub, a self-consciously cool, yet remarkably successful hotel wrought from an anonymous 1980s office block a few streets back from the Bosphorus shoreline ",imgCount: 4, image:["karakoy","karakoy1","karakoy2", "karakoy3"],  isVisited: false),
//
//            Hotel(name: "Yasmak Sultan",  website: "yasmakhotelcollection.com", location: "Ebussuud Cadessi No:12, 34110 Istanbul, Turkey", phone: "02125281343", summary: "Ideally located on the fringes of Istanbul's Sultanahmet tourist heartland, this perennially popular traditional hotel is justly renowned for its friendly and efficient staff, excellent rooftop restaurant complete with panoramic old city views, and value for money.",imgCount: 4, image:["sultan","sultan1", "sultan2", "sultan3"], isVisited: false),
//
//            Hotel(name: "Hotel Unique", website: "hoteluniqueturkey.com", location: "Karagözler Mah, Fevzi Çakmak Caddesi, Birinci Karagözler, Fethiye, Turkey", phone: "902526121145", summary: "A small but perfectly formed boutique hotel with real flair, built on a difficult, steeply sloping plot opposite the marina, it exemplifies just how far Fethiye has distanced itself from the mass-market ugliness of nearby Ovacık and Hissarönü.", imgCount: 4,image:["unique", "unique1" ,"unique2","unique3"],  isVisited: false),
//
//            Hotel(name: "Shangri-La Bosphorus",  website: "shangri-la.com", location: "Sinan Pasa Mah. Hayrettin Iskelesi Sok. No:1 Besiktas, Istanbul, 34353, Turkey", phone: "00902122758888", summary: "This abandoned former tobacco warehouse which dates back to the Roaring Twenties, has been given a vibrant lease of life as one of Istanbul's most prestigious hotels. Virtually hugging the waterfront on the European side of the historic Bosphorus Strait, the views from front rooms and the restaurant terrace are superb.",imgCount: 4, image:["bosphorus", "bosphorus1","bosphorus2", "bosphorus3"], isVisited: false),
//
//            Hotel(name: "Hotel Patara Viewpoint", website: "pataraviewpoint.com", location: "Gelemiş, 07976 Kaş/Antalya, Turkey", phone: "0090 242 843 5184", summary: "The guests at this charmingly rustic hotel are mainly couples and families seeking a relaxing base from which to explore this beautiful region’s atmospheric ancient sites, walk sections of the superb Lycian Way coastal trail, or lounge on one of the Mediterranean’s longest, least crowded beaches.",imgCount: 4, image:["patara", "patara1","patara2","patara3"],    isVisited: false)
//
//
//
//
